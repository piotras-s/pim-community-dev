...
class EditCommonAttributesTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInitialize()
    {
        ...
        $sku         = $this->getProductAttributeInterfaceMock('sku', 'pim_catalog_identifier');
        $name        = $this->getProductAttributeInterfaceMock('name', 'text', false, true);
        $color       = $this->getProductAttributeInterfaceMock('color');
        $description = $this->getProductAttributeInterfaceMock('description', 'text', true);
        $price       = $this->getProductAttributeInterfaceMock('price', 'pim_catalog_price_collection');
     ...
     */
    protected function getProductAttributeInterfaceMock($code, $type = 'text', $scopable = false, $translatable = false)
    {
