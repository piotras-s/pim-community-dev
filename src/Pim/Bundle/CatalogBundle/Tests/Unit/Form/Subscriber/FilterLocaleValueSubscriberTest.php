...
class FilterLocaleValueSubscriberTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPreSetData()
    {
        $data = array(
            'name_current'               => $this->getProductValueMock(
                $this->getProductAttributeInterfaceMock(),
                self::CURRENT_LOCALE
            ),
            ...
            'not_translatable_attribute' => $this->getProductValueMock($this->getProductAttributeInterfaceMock(false), null),
        );
    ...
    {
        $data = array(
            'name_current'    => $this->getProductValueMock($this->getProductAttributeInterfaceMock(), self::CURRENT_LOCALE),
            'name_comparison' => $this->getProductValueMock($this->getProductAttributeInterfaceMock(), self::COMPARISON_LOCALE),
        );
     ...
     */
    private function getProductAttributeInterfaceMock($translatable = true)
    {
