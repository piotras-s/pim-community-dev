...
class FlatAttributeNormalizerTest extends AttributeNormalizerTest
{
    ...
    {
        return array(
            array('Pim\Bundle\CatalogBundle\Model\ProductAttributeInterface', 'csv', true),
            array('Pim\Bundle\CatalogBundle\Model\ProductAttributeInterface', 'xml', false),
            array('Pim\Bundle\CatalogBundle\Model\ProductAttributeInterface', 'json', false),
